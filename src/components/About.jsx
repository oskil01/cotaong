...
export default function AboutSection() {
  return (
    <section
      ...
      md:py-20 md:px-12 lg:px-20 text-white"
    >
      <div className="max-w-6xl mx-auto w-full flex flex-col lg:flex-row items-center justify-between">
        {/* 🌊 Fond animé */}
        ...
        <div className="absolue inset-0 bg-gradient-to-br from-[#03337F]/70 to-[#0069BD]/70 mix-blend-overlay"></div>
        ...
        >
          <div
            className="w-full max-w-6xl max-auto lg:max-w-lg
        ...
        >
          ...
          <p
            className="text-gray-200 text-md md:text-lg mb-6 leading-relaxed lg:mx-0"
            data-aos="fade-left"
            data-aos-delay="100"
          >
            Nous sommes une ONG sans lucratif de droit congolais,
            humanitaire, innovante, multisectorielle et professionnelle,
            spécialisée dans l’accompagnement technique et stratégique aux
            entreprises, ONG, institutions publiques et communautés. 
          </p>
          ...
          >
            ...
            >
              ...
              <p className="text-gray-600 text-sm md:text-md">
                Accompagner en technique et en stratégie les partenaires afin de
            ...
            >
              ...
              <p className="text-gray-600 text-md md:text-md">
                Devenir un acteur de référence en
                accompagnement technique et en innovation en RDC.
              </p>
            </div>
          </div>
          ...
          >
            ...
            font-medium px-6 py-3 rounded-sm md:py-4
