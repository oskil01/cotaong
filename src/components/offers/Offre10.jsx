...
export default function Offre09() {
  ...
  const offre = {
    titre: "Superviseurs Terrain",
    organisation: "Corps Technique pour l’Accompagnement (COTA)",
    reference: "10/COTA/ESC-BD/RDC/026",
    ...
    responsable: "Coordonnateur Terrain",
  };
    ...
    <div className="text-gray-800 flex justify-center">
      ...
      <section className="w-full max-w-6xl px-4 pt-28 py-12 space-y-12">
        <h3 className="text-sm uppercase font-semibold mb-5 text-center">
          APPEL A CANDIDATURES 10/COTA/ESC-BD/RDC/026
        </h3>
        <h1 className="text-3xl md:text-4xl font-bold mt-3 text-center">
          Recrutement des Superviseurs Terrain pour la constitution 
        ...
        <ArticleSection
          ...
          content={
            <>
              <p>
               Sous la supervision directe du Coordonnateur Terrain, le Superviseur 
               Terrain est chargé d'assurer l'encadrement opérationnel des enquêteurs 
               ainsi que le contrôle permanent de la qualité des données collectées sur le terrain.
               <br /> <br />
               Il veille au respect des méthodologies de collecte, des procédures de travail, 
               des normes éthiques et des calendriers d'exécution afin de garantir la production 
               de données fiables, complètes et exploitables pour les besoins des études, évaluations, 
               recherches et projets mis en œuvre par COTA et ses partenaires.
              </p>
            </>
          }
        />
          ...
          content={
            <>
              <ul className="list-disc pl-6 space-y-1">
                <li> Encadrer directement les enquêteurs ;</li> 
                <li> Organiser les activités quotidiennes de collecte ; 
                </li>
                <li> Contrôler la qualité des questionnaires administrés ; 
                </li>
                <li> Réaliser les contre-vérifications et back-checks ; 
                </li>
                <li> Vérifier la cohérence des données collectées ; 
                </li>
                <li> Assurer le respect des procédures méthodologiques ; </li>
                <li> Accompagner les enquêteurs sur le terrain ; </li>
                <li> Produire les rapports journaliers ; </li> 
                <li> Identifier et résoudre les difficultés rencontrées ; </li>
                <li> Veiller au respect des règles d'éthique et de confidentialité. </li>
              </ul>
            </>
          }
        />
      ...
      <div className="fixed bottom-20 xl:bottom-6 left-1/2 transform -translate-x-1/2 flex gap-4 z-50">
        ...
        {/* Télécharger */}
        <a
          href="/offrespdf/10_COTA_ESC_RDC_2026.pdf"
          download="10_COTA_ESC_RDC_2026.pdf"
              ...
              if (navigator.share) {
                try {
                  await navigator.share({
                    ...
                    text: `Appel à candidatures : Recrutement des Superviseurs Terrain pour la constitution de la base des données des agents temporaires.`,
